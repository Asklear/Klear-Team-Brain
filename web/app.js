...
const I18N = {
  en: {
    ...
    "ov.attentionHead": "Active after last push",
    ...
    "ov.branchesUnpushed": (n) => `${n} active after push`,
    "ov.allPushed": "Nothing newer than last push ✓",
    ...
    "repos.unpushedBadge": (n) => `${n} after push`,
    ...
    "cs.openPR": "Open PRs",
    "cs.unpushed": "after push",
    "cs.unpushedTitle": "A session on this branch is newer than its last push — post-push activity, not necessarily unpushed commits",
  ...
  zh: {
    ...
    "ov.branchesUnpushed": (n) => `${n} 个分支 push 后有活动`,
    "ov.allPushed": "无晚于 push 的活动 ✓",
    "ov.noMirror": "还没有文档镜像。",
    "load.repos": "加载仓库",
    ...
    "cs.openPR": "Open PR",
    "cs.unpushed": "晚于推送",
    "cs.unpushedTitle": "本分支有比最后一次 push 更晚的 session —— push 后的活动，不一定有未推 commit",
